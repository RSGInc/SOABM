#########################################################################################
### Script for summarizing ABM Output
### Author: Binny M Paul, binny.paul@rsginc.com, 08/31/2015
###
### Start with a new R session, make sure dplyr library is not loaded
### in the same session
### Update all the paths under "User Inputs" and run
### Besides ABM output, the script reads geographic correspondence and OMX skim as input
### Outputs are written to WD
#########################################################################################
...
# User Inputs
WD <- "E:/Projects/Clients/odot/SouthernOregonABM/Calibration_Round1/081817_1_agedPop/ABM_Summaries"
ABMOutputDir <- "E:/Projects/Clients/odot/SouthernOregonABM/Calibration_Round1/081817_1_agedPop/outputs"
mazdatapath <- "E:/Projects/Clients/odot/SouthernOregonABM/Calibration_Template/inputs"
skimFilePath <- "E:/Projects/Clients/odot/SouthernOregonABM/Calibration_Round1/081817_1_agedPop/outputs"
skimFile <- "taz_skim_sov_am.omx"
OMXSourcePath <- "E:/Projects/Clients/odot/RScripts"

setwd(OMXSourcePath)
source("omx.r")

setwd(ABMOutputDir)
hh <- read.csv("householdData_1.csv")
per <- read.csv("personData_1.csv")
tours <- read.csv("indivTourData_1.csv")
trips <- read.csv("indivTripData_1.csv")
jtrips <- read.csv("jointTripData_1.csv")
unique_joint_tours <- read.csv("jointTourData_1.csv")

wsLoc <- read.csv("wsLocResults_1.csv")
aoResults <- read.csv("aoResults.csv")
aoResults_Pre <- read.csv("aoResults_Pre.csv")

setwd(mazdatapath)
mazCorrespondence <- read.csv("maz_data_export.csv")

setwd(skimFilePath)
#skim <- read.csv("Skim.csv")
skimMat3 <- readMatrixOMX(skimFile, "3", ,)
skimLookUp <- readLookupOMX(skimFile, "NO")
...
wsLoc$HCOUNTY <- mazCorrespondence$COUNTY[match(wsLoc$HomeMGRA, mazCorrespondence$MAZ)]
wsLoc$WCOUNTY <- mazCorrespondence$COUNTY[match(wsLoc$WorkLocation, mazCorrespondence$MAZ)]
...
hh$HHTAZ <- mazCorrespondence$TAZ[match(hh$home_maz, mazCorrespondence$MAZ)]
...
tlfd_work_Jackson <- hist(workers$WorkLocationDistance[workers$HCOUNTY=="JacksonCounty"], breaks = c(seq(0,40, by=1), 9999), freq = NULL, right=FALSE)
tlfd_work_Josephine <- hist(workers$WorkLocationDistance[workers$HCOUNTY=="JosephineCounty"], breaks = c(seq(0,40, by=1), 9999), freq = NULL, right=FALSE)
tlfd_work_Total <- hist(workers$WorkLocationDistance, breaks = c(seq(0,40, by=1), 9999), freq = NULL, right=FALSE)

tlfd_univ_Jackson <- hist(students$SchoolLocationDistance[students$HCOUNTY=="JacksonCounty" & students$PersonType==3], breaks = c(seq(0,40, by=1), 9999), freq = NULL, right=FALSE)
tlfd_univ_Josephine <- hist(students$SchoolLocationDistance[students$HCOUNTY=="JosephineCounty" & students$PersonType==3], breaks = c(seq(0,40, by=1), 9999), freq = NULL, right=FALSE)
tlfd_univ_Total <- hist(students$SchoolLocationDistance[students$PersonType==3], breaks = c(seq(0,40, by=1), 9999), freq = NULL, right=FALSE)

tlfd_schl_Jackson <- hist(students$SchoolLocationDistance[students$HCOUNTY=="JacksonCounty" & students$PersonType>=6], breaks = c(seq(0,40, by=1), 9999), freq = NULL, right=FALSE)
tlfd_schl_Josephine <- hist(students$SchoolLocationDistance[students$HCOUNTY=="JosephineCounty" & students$PersonType>=6], breaks = c(seq(0,40, by=1), 9999), freq = NULL, right=FALSE)
tlfd_schl_Total <- hist(students$SchoolLocationDistance[students$PersonType>=6], breaks = c(seq(0,40, by=1), 9999), freq = NULL, right=FALSE)

#TLDF_Jackson <- data.frame(tlfd_work_Jackson$counts, tlfd_univ_Jackson$counts, tlfd_schl_Jackson$counts)
#TLDF_Josephine <- data.frame(tlfd_work_Josephine$counts, tlfd_univ_Josephine$counts, tlfd_schl_Josephine$counts)
#
#colnames(TLDF_Jackson) <- c("work", "univ", "schl")
#colnames(TLDF_Josephine) <- c("work", "univ", "schl")
#
#write.csv(TLDF_Jackson, "TLDF_Jackson.csv")
#write.csv(TLDF_Josephine, "TLDF_Josephine.csv")
...
cat("\n Average distance to workplace (Jackson): ", mean(workers$WorkLocationDistance[workers$HCOUNTY=="JacksonCounty"], na.rm = TRUE))
cat("\n Average distance to university (Jackson): ", mean(students$SchoolLocationDistance[students$HCOUNTY=="JacksonCounty" & students$PersonType==3], na.rm = TRUE))
cat("\n Average distance to school (Jackson): ", mean(students$SchoolLocationDistance[students$HCOUNTY=="JacksonCounty" & students$PersonType>=6], na.rm = TRUE))

cat("\n Average distance to workplace (Josephine): ", mean(workers$WorkLocationDistance[workers$HCOUNTY=="JosephineCounty"], na.rm = TRUE))
cat("\n Average distance to university (Josephine): ", mean(students$SchoolLocationDistance[students$HCOUNTY=="JosephineCounty" & students$PersonType==3], na.rm = TRUE))
cat("\n Average distance to school (Josephine): ", mean(students$SchoolLocationDistance[students$HCOUNTY=="JosephineCounty" & students$PersonType>=6], na.rm = TRUE))
...
workTripLengths <- c(mean(workers$WorkLocationDistance[workers$HCOUNTY=="JacksonCounty"], na.rm = TRUE),
                     mean(workers$WorkLocationDistance[workers$HCOUNTY=="JosephineCounty"], na.rm = TRUE),
                     mean(workers$WorkLocationDistance, na.rm = TRUE))

univTripLengths <- c(mean(students$SchoolLocationDistance[students$HCOUNTY=="JacksonCounty" & students$PersonType==3], na.rm = TRUE),
                     mean(students$SchoolLocationDistance[students$HCOUNTY=="JosephineCounty" & students$PersonType==3], na.rm = TRUE),
                     mean(students$SchoolLocationDistance[students$PersonType==3], na.rm = TRUE))

schlTripLengths <- c(mean(students$SchoolLocationDistance[students$HCOUNTY=="JacksonCounty" & students$PersonType>=6], na.rm = TRUE),
                     mean(students$SchoolLocationDistance[students$HCOUNTY=="JosephineCounty" & students$PersonType>=6], na.rm = TRUE),
                     mean(students$SchoolLocationDistance[students$PersonType>=6], na.rm = TRUE))
...
jackworkers <- sum(wsLoc$WorkLocation[wsLoc$HCOUNTY=="JacksonCounty"] > 0 , na.rm=TRUE)
jackwhm <- sum(wsLoc$WorkLocation[wsLoc$HCOUNTY=="JacksonCounty"] == 99999, na.rm=TRUE)

joseworkers <- sum(wsLoc$WorkLocation[wsLoc$HCOUNTY=="JosephineCounty"] > 0 , na.rm=TRUE)
josewhm <- sum(wsLoc$WorkLocation[wsLoc$HCOUNTY=="JosephineCounty"] == 99999, na.rm=TRUE)
...
# County-County Flows
josephine_josephine<-sum(workers$HCOUNTY=="JosephineCounty" & workers$WCOUNTY=="JosephineCounty", na.rm=TRUE)
josephine_josephine

josephine_jackson<-sum(workers$HCOUNTY=="JosephineCounty" & workers$WCOUNTY=="JacksonCounty", na.rm=TRUE)
josephine_jackson

jackson_josephine<-sum(workers$HCOUNTY=="JacksonCounty" & workers$WCOUNTY=="JosephineCounty", na.rm=TRUE)
jackson_josephine

jackson_jackson<-sum(workers$HCOUNTY=="JacksonCounty" & workers$WCOUNTY=="JacksonCounty", na.rm=TRUE)
jackson_jackson
...
tours$OTAZ <- mazCorrespondence$TAZ[match(tours$orig_maz, mazCorrespondence$MAZ)]
tours$DTAZ <- mazCorrespondence$TAZ[match(tours$dest_maz, mazCorrespondence$MAZ)]
...
unique_joint_tours$OTAZ <- mazCorrespondence$TAZ[match(unique_joint_tours$orig_maz, mazCorrespondence$MAZ)]
unique_joint_tours$DTAZ <- mazCorrespondence$TAZ[match(unique_joint_tours$dest_maz, mazCorrespondence$MAZ)]
...
trips$OTAZ <- mazCorrespondence$TAZ[match(trips$orig_maz, mazCorrespondence$MAZ)]
trips$DTAZ <- mazCorrespondence$TAZ[match(trips$dest_maz, mazCorrespondence$MAZ)]
...
stops$tripoindex<-match(stops$OTAZ, skimLookUp$Lookup)
stops$tripdindex<-match(stops$DTAZ, skimLookUp$Lookup)
stops$finaldindex<-match(stops$finaldestTAZ, skimLookUp$Lookup)

stops$od_dist<-skimMat3[cbind(stops$tripoindex, stops$finaldindex)]										
...
jtrips$OTAZ <- mazCorrespondence$TAZ[match(jtrips$orig_mgra, mazCorrespondence$MAZ)]
jtrips$DTAZ <- mazCorrespondence$TAZ[match(jtrips$dest_mgra, mazCorrespondence$MAZ)]
...
jstops$tripoindex<-match(jstops$OTAZ, skimLookUp$Lookup)
jstops$tripdindex<-match(jstops$DTAZ, skimLookUp$Lookup)
jstops$finaldindex<-match(jstops$finaldestTAZ, skimLookUp$Lookup)

jstops$od_dist<-skimMat3[cbind(jstops$tripoindex, jstops$finaldindex)]										
jstops$os_dist<-skimMat3[cbind(jstops$tripoindex, jstops$tripdindex)]										
jstops$sd_dist<-skimMat3[cbind(jstops$tripdindex, jstops$finaldindex)]		
...
tmode4_as0 <- hist(tours$TOURMODE[tours$TOURPURP>=5 & tours$TOURPURP<=6 & tours$AUTOSUFF==0], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
...
tmode6_as0 <- hist(unique_joint_tours$TOURMODE[unique_joint_tours$JOINT_PURP>=5 & unique_joint_tours$JOINT_PURP<=6 & unique_joint_tours$AUTOSUFF==0], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
tmode7_as0 <- hist(unique_joint_tours$TOURMODE[unique_joint_tours$JOINT_PURP>=7 & unique_joint_tours$JOINT_PURP<=9 & unique_joint_tours$AUTOSUFF==0], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
...
tmode4_as1 <- hist(tours$TOURMODE[tours$TOURPURP>=5 & tours$TOURPURP<=6 & tours$AUTOSUFF==1], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
...
tmode6_as1 <- hist(unique_joint_tours$TOURMODE[unique_joint_tours$JOINT_PURP>=5 & unique_joint_tours$JOINT_PURP<=6 & unique_joint_tours$AUTOSUFF==1], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
tmode7_as1 <- hist(unique_joint_tours$TOURMODE[unique_joint_tours$JOINT_PURP>=7 & unique_joint_tours$JOINT_PURP<=9 & unique_joint_tours$AUTOSUFF==1], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
...
tmode4_as2 <- hist(tours$TOURMODE[tours$TOURPURP>=5 & tours$TOURPURP<=6 & tours$AUTOSUFF==2], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
...
tmode6_as2 <- hist(unique_joint_tours$TOURMODE[unique_joint_tours$JOINT_PURP>=5 & unique_joint_tours$JOINT_PURP<=6 & unique_joint_tours$AUTOSUFF==2], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
tmode7_as2 <- hist(unique_joint_tours$TOURMODE[unique_joint_tours$JOINT_PURP>=7 & unique_joint_tours$JOINT_PURP<=9 & unique_joint_tours$AUTOSUFF==2], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
...
avgTripLengths <- c(mean(tours$tour_distance[tours$TOURPURP==4], na.rm = TRUE),
                    ...
                    mean(tours$tour_distance, na.rm = TRUE))
...
#iMain
tripmode1 <- hist(trips$TRIPMODE[trips$TRIPMODE>0 & trips$TOURPURP>=5 & trips$TOURPURP<=6 & trips$TOURMODE==1], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
tripmode2 <- hist(trips$TRIPMODE[trips$TRIPMODE>0 & trips$TOURPURP>=5 & trips$TOURPURP<=6 & trips$TOURMODE==2], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
tripmode3 <- hist(trips$TRIPMODE[trips$TRIPMODE>0 & trips$TOURPURP>=5 & trips$TOURPURP<=6 & trips$TOURMODE==3], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
tripmode4 <- hist(trips$TRIPMODE[trips$TRIPMODE>0 & trips$TOURPURP>=5 & trips$TOURPURP<=6 & trips$TOURMODE==4], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
tripmode5 <- hist(trips$TRIPMODE[trips$TRIPMODE>0 & trips$TOURPURP>=5 & trips$TOURPURP<=6 & trips$TOURMODE==5], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
tripmode6 <- hist(trips$TRIPMODE[trips$TRIPMODE>0 & trips$TOURPURP>=5 & trips$TOURPURP<=6 & trips$TOURMODE==6], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
tripmode7 <- hist(trips$TRIPMODE[trips$TRIPMODE>0 & trips$TOURPURP>=5 & trips$TOURPURP<=6 & trips$TOURMODE==7], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
tripmode8 <- hist(trips$TRIPMODE[trips$TRIPMODE>0 & trips$TOURPURP>=5 & trips$TOURPURP<=6 & trips$TOURMODE==8], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
tripmode9 <- hist(trips$TRIPMODE[trips$TRIPMODE>0 & trips$TOURPURP>=5 & trips$TOURPURP<=6 & trips$TOURMODE==9], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
...
#jMain
tripmode1 <- hist(jtrips$TRIPMODE[jtrips$TRIPMODE>0 & jtrips$TOURPURP>=5 & jtrips$TOURPURP<=6 & jtrips$TOURMODE==1], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
tripmode2 <- hist(jtrips$TRIPMODE[jtrips$TRIPMODE>0 & jtrips$TOURPURP>=5 & jtrips$TOURPURP<=6 & jtrips$TOURMODE==2], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
tripmode3 <- hist(jtrips$TRIPMODE[jtrips$TRIPMODE>0 & jtrips$TOURPURP>=5 & jtrips$TOURPURP<=6 & jtrips$TOURMODE==3], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
tripmode4 <- hist(jtrips$TRIPMODE[jtrips$TRIPMODE>0 & jtrips$TOURPURP>=5 & jtrips$TOURPURP<=6 & jtrips$TOURMODE==4], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
tripmode5 <- hist(jtrips$TRIPMODE[jtrips$TRIPMODE>0 & jtrips$TOURPURP>=5 & jtrips$TOURPURP<=6 & jtrips$TOURMODE==5], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
tripmode6 <- hist(jtrips$TRIPMODE[jtrips$TRIPMODE>0 & jtrips$TOURPURP>=5 & jtrips$TOURPURP<=6 & jtrips$TOURMODE==6], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
tripmode7 <- hist(jtrips$TRIPMODE[jtrips$TRIPMODE>0 & jtrips$TOURPURP>=5 & jtrips$TOURPURP<=6 & jtrips$TOURMODE==7], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
tripmode8 <- hist(jtrips$TRIPMODE[jtrips$TRIPMODE>0 & jtrips$TOURPURP>=5 & jtrips$TOURPURP<=6 & jtrips$TOURMODE==8], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
tripmode9 <- hist(jtrips$TRIPMODE[jtrips$TRIPMODE>0 & jtrips$TOURPURP>=5 & jtrips$TOURPURP<=6 & jtrips$TOURMODE==9], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
...
#jDisc
tripmode1 <- hist(jtrips$TRIPMODE[jtrips$TRIPMODE>0 & jtrips$TOURPURP>=7 & jtrips$TOURPURP<=9 & jtrips$TOURMODE==1], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
tripmode2 <- hist(jtrips$TRIPMODE[jtrips$TRIPMODE>0 & jtrips$TOURPURP>=7 & jtrips$TOURPURP<=9 & jtrips$TOURMODE==2], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
tripmode3 <- hist(jtrips$TRIPMODE[jtrips$TRIPMODE>0 & jtrips$TOURPURP>=7 & jtrips$TOURPURP<=9 & jtrips$TOURMODE==3], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
tripmode4 <- hist(jtrips$TRIPMODE[jtrips$TRIPMODE>0 & jtrips$TOURPURP>=7 & jtrips$TOURPURP<=9 & jtrips$TOURMODE==4], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
tripmode5 <- hist(jtrips$TRIPMODE[jtrips$TRIPMODE>0 & jtrips$TOURPURP>=7 & jtrips$TOURPURP<=9 & jtrips$TOURMODE==5], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
tripmode6 <- hist(jtrips$TRIPMODE[jtrips$TRIPMODE>0 & jtrips$TOURPURP>=7 & jtrips$TOURPURP<=9 & jtrips$TOURMODE==6], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
tripmode7 <- hist(jtrips$TRIPMODE[jtrips$TRIPMODE>0 & jtrips$TOURPURP>=7 & jtrips$TOURPURP<=9 & jtrips$TOURMODE==7], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
tripmode8 <- hist(jtrips$TRIPMODE[jtrips$TRIPMODE>0 & jtrips$TOURPURP>=7 & jtrips$TOURPURP<=9 & jtrips$TOURMODE==8], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
tripmode9 <- hist(jtrips$TRIPMODE[jtrips$TRIPMODE>0 & jtrips$TOURPURP>=7 & jtrips$TOURPURP<=9 & jtrips$TOURMODE==9], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
...
#jTotal
jtripmode1 <- hist(jtrips$TRIPMODE[jtrips$TRIPMODE>0 & jtrips$TOURMODE==1], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
jtripmode2 <- hist(jtrips$TRIPMODE[jtrips$TRIPMODE>0 & jtrips$TOURMODE==2], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
jtripmode3 <- hist(jtrips$TRIPMODE[jtrips$TRIPMODE>0 & jtrips$TOURMODE==3], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
jtripmode4 <- hist(jtrips$TRIPMODE[jtrips$TRIPMODE>0 & jtrips$TOURMODE==4], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
jtripmode5 <- hist(jtrips$TRIPMODE[jtrips$TRIPMODE>0 & jtrips$TOURMODE==5], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
jtripmode6 <- hist(jtrips$TRIPMODE[jtrips$TRIPMODE>0 & jtrips$TOURMODE==6], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
jtripmode7 <- hist(jtrips$TRIPMODE[jtrips$TRIPMODE>0 & jtrips$TOURMODE==7], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
jtripmode8 <- hist(jtrips$TRIPMODE[jtrips$TRIPMODE>0 & jtrips$TOURMODE==8], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
jtripmode9 <- hist(jtrips$TRIPMODE[jtrips$TRIPMODE>0 & jtrips$TOURMODE==9], breaks = seq(1,10, by=1), freq = NULL, right=FALSE)
...
cat("Total number of tours : ", nrow(tours) + nrow(unique_joint_tours))


# output total numbers in a file
total_population <- sum(pertypeDistbn$freq)
total_households <- nrow(hh)
total_tours <- nrow(tours) + nrow(unique_joint_tours)
