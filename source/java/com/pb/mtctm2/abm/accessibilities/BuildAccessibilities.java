        ...
        implements Serializable
{
    ...
    private int                         maz_packet_size                          = 500;
    ...
    public void setupBuildAccessibilities(HashMap<String, String> rbMap)
    {
        ...
        maz_packet_size = Util.getIntegerValueFromPropertyMap(rbMap, "acc.jppf.packet.size");
...
//            }
    ...
    private ArrayList<int[]> calcStartEndIndexList()
    {
        ...
        int packetSize = maz_packet_size;
    ...
    private float[][] submitTasksJPPF(ArrayList<int[]> startEndIndexList, HashMap<String, String> rbMap)
    {
        ...
        try
        {
            ...
            try{
            	...
            	logger.error("Exception caught submitting DC utilities task to JPPF client");
            	logger.error("taskIndex: "+taskIndex+ " startIndex: "+startIndex+" endIndex: "+endIndex);
            	throw new RuntimeException();
            }
