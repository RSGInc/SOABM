    ...
    public void mapTablesToHouseholdObjects()
    {
        ...
        for (int r = 1; r <= hhTable.getRowCount(); r++)
        {
            ...
            try
            {
                ...
                // GQTYPE 0=Housing unit, 1==Noninstitutional group quarters
                // unitType 0=Housing unit, 1 = instit. GQ (none) 2 = NonInst GQ
                int gqType = (int) hhTable.getValueAt(r, hhTable.getColumnPosition(HH_GQTYPE_FIELD_NAME));
                int unitType = gqType==1 ? 2: 0;
