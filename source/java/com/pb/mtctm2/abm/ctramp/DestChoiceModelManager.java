        ...
        implements Serializable
{
            ...
            String dcUecFileName, String soaUecFileName, int soaSampleSize, CtrampDmuFactoryIf dmuFactory, String restartModelString)
    {
        ...
        logger.info("Initializing matrix server in DestChoiceModelManager");
        if (ms == null)
        {
            if (mdm != null)
            {
        ...
        } else if (mdm == null)
        {
            ...
            logger.info(Thread.currentThread().getName() + ": successfully set matrix data server object");
        } else
        {
	...
	public AutoTazSkimsCalculator getTazDistanceCalculator() {
		return tazDistanceCalculator;
	}
