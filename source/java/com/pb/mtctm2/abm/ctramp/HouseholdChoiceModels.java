...
public class HouseholdChoiceModels implements Serializable
{
    ...
    private MajorUniversityStudentDestChoiceModel                    musdcModel;
    ...
    public HouseholdChoiceModels( int modelIndex, String restartModelString,
            ...
            double[][][] subTourSoaDistProbs, double[][][] subTourSoaSizeProbs,AutoTazSkimsCalculator tazDistanceCalculator )
    {
        ...
        try
        {
            ...
            if (runIndividualMandatoryTourFrequencyModel) {
                ...
                musdcModel = new MajorUniversityStudentDestChoiceModel(propertyMap, mgraManager);
                if ( measureObjectSizes ) logger.info ( "IMTF size:       " + ObjectUtil.sizeOf( imtfModel ) + ObjectUtil.sizeOf(musdcModel));
            }
    ...
    public void runModels(Household hhObject)
    {
        ...
        if (runIndividualMandatoryTourFrequencyModel){
            ...
            musdcModel.chooseDestination(hhObject);
        }
        if (runMandatoryTourDepartureTimeAndDurationModel)
