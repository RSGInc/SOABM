        ...
        implements Serializable
{
    ...
    private byte      tourParkSpaceType;
    ...
    public byte getTourParkSpaceType() {
		return tourParkSpaceType;
	}

	public void setTourParkSpaceType(byte tourParkSpaceType) {
		this.tourParkSpaceType = tourParkSpaceType;
	}
     ...
     */
    public Stop createStop( String origPurp, String destPurp, boolean inbound, boolean subtour ) {
        Stop stop = null;
        int id = -1;
        if ( inbound ) {
