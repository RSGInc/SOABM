        ...
        implements Serializable
{
   ...
   public int getStopPurposeIndex()
	...
	public boolean isUniversityParkingLot() {
		return universityParkingLot;
	}

	public void setUniversityParkingLot(boolean universityParkingLot) {
		this.universityParkingLot = universityParkingLot;
	}
	...
	public void logStopObject( Logger logger, int totalChars ) {
        ...
        Household.logHelper( logger, "university parking lot: ",universityParkingLot ? "true" : "false", totalChars);
