        ...
        implements Serializable
{
    ...
    public static final String[] MODEL_PERIOD_LABELS = { "EA", "AM", "MD", "PM", "EV" };
                                                          ...
                                                          //3 AM - 7 AM, 7 AM - 8:30 AM, 8:30 AM - 4:30 AM, 4:30 PM - 6:30 PM, 6:30 PM - 3 AM
    // the upper TOD interval index for each model period (EA:1-3, AM:6-9, MD:10-22, PM:23-29, EV:30-40) 
    public static final int UPPER_EA = 5;
    public static final int UPPER_AM = 8;
    public static final int UPPER_MD = 24;
    public static final int UPPER_PM = 28;
    ...
    abstract public int getWalkTransitTripMode();
    abstract public int getWalkTripMode();
