...
### Base Jobs
```{r Jobs1_ValueBox}
  valueBox(prettyNum(round(build_df$value[build_df$name=="total_jobs"]), big.mark = ","), "Employment (MAZData)", icon = "fas fa-industry")
```
...
### Build Workers
```{r Workers1_ValueBox}
valueBox(prettyNum(round(build_df$value[build_df$name=="total_workers"]/BUILD_SAMPLE_RATE), big.mark = ","), "Workers", icon = "fas fa-industry")
```
