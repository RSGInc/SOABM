...
if(IS_BASE_SURVEY=="Yes"){
  #   Survey Base
  BASE_SCENARIO_ALT     <- "OHAS_Oregon"
  #DISTRICT_FLOW_CENSUS  <- "5 year ACS (2009-13)"
  DISTRICT_FLOW_CENSUS  <- "OHAS"
...
timePeriods           <- c("EV1","EA","AM","MD","PM","EV2")
aggTimePeriods        <- c("EV1","EA","AM","MD","PM","EV2", "Daily")
