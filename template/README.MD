...
Download this template setup folder that includes the following folders and files.
  ...
  - inputs – Popsyn input files, VISUM scenario version file, external model input files (THESE ARE NOT IN THIS REPO)
